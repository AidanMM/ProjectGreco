        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            if (left == false)
            {
                ...
                spriteBatch.Draw(animationList[animationListIndex][frameIndex],
                    new Vector2(player.Position.X - (int)Game1.CAMERA_DISPLACEMENT.X + player.Width / 2 - 8, player.Position.Y - (int)Game1.CAMERA_DISPLACEMENT.Y + 3* player.Height / 4),
            ...
            else if (left == true)
            {
                angle -= .12f;
                spriteBatch.Draw(animationList[animationListIndex][frameIndex],
                    new Vector2(player.Position.X - (int)Game1.CAMERA_DISPLACEMENT.X + player.Width - 12, player.Position.Y - (int)Game1.CAMERA_DISPLACEMENT.Y + 3 * player.Height / 4 + 1),
                    new Rectangle(0, 0, collisionBox.Width, collisionBox.Height),
                    Color.White,
                    angle,
